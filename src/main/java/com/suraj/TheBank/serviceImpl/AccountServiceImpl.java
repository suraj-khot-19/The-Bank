...
import com.suraj.TheBank.exception.MinBalanceException;
...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public Map<String, String> depositMoney(long accountNumber, double amount) {
    ...
    /// delete an account
    @Override
    public Map<String, String> deleteAccount(long accountNumber) {
        repo.findById(accountNumber).orElseThrow(() -> new AccountException("Your account is not associated with our bank"));

        repo.deleteById(accountNumber);
        return Map.of("Message", "Account deleted with Number " + accountNumber);
    }
}
